        ...
        <Cont>
            <Wrapper>
                ...
                <Detail>
                    ...
                    <BookBtn>
                        {showStarted?<button><a style={{textDecoration:"none",color:"white"}}href={`https://meet.jit.si/streamline2/${show._id}`}  >Start the show</a></button>:<CountDownParent showTime={showTime} setShowStarted={setShowStarted}/> }
                    </BookBtn>
                </Detail>
            </Wrapper>
        </Cont>
